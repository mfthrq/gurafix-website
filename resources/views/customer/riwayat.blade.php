            ...
            <div class="row">
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="single-feature-inner style-2">
                        <div class="details">
                            <h4 class="text-white">{{ $pemesanan->layanan->nama }}</h4>
                            <div class="border-bottom-1 align-items-center pb-4 mb-4">
                                <div class="d-flex align-items-center mt-3">
                                    <div class="img border-radius-5 overflow-hidden me-3">
                                        <img src="{{ asset('assets_admin/gambar_paket/' . $pemesanan->paket->gambar_paket) }}" height="60px" alt="img">
                                    </div>
                                ...
                                <div class="mt-3">
                                    @switch($pemesanan->status)
                                        @case('Menunggu Pembayaran')
                                            <span class="badge bg-secondary badge-custom" style="font-size: 15px;">Menunggu Pembayaran</span>
                                            @break
                                
                                        @case('Pembayaran Berhasil')
                                            <span class="badge bg-success badge-custom" style="font-size: 15px;">Pembayaran Berhasil</span>
                                            @break
                                
                                        @case('Progress')
                                            <span class="badge bg-warning badge-custom" style="font-size: 15px; color: black;">Progress</span>
                                            @break
                                
                                        @case('Revisi')
                                            <span class="badge bg-warning badge-custom" style="font-size: 15px; color: black;">Revisi</span>
                                            @break
                                        ...
                                        @default
                                            <span class="badge bg-secondary badge-custom" style="font-size: 15px;">Status Tidak Diketahui</span>
                                    @endswitch
                                </div>
                                <div class="mt-3">
                                    <p class="d-block mb-0" style="color: white">
                                        Total Biaya: <b>Rp{{ number_format($pemesanan->paket->harga, 0, ',', '.') }}</b>
                                    </p>
                                </div> 
                            </div>
                            ...
                            <div class="justify-content-between align-items-center">
                                <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 0.5rem;">
                                    {{-- <div>
                                        <a class="btn btn-base" style="background-color: #ddf100; width: 100%;" href="#">
                                            Bayar
                                        </a>
                                    </div> --}}
                                    {{-- <div>
                                        <a class="btn btn-base" style="background-color: #5ecdf8; width: 100%;" href="#">
                                            Detail
                                        </a>
                                    </div> --}}
                                    <div>
                                        <a class="btn btn-base" style="width: 100%;" href="{{ $pemesanan->link_desain ?? '#' }}">
