  ...
  <body>
    ...
    <div class="banner-area banner-area-3" style="background-color: #004ce7">
      <div class="container position-relative">
        <div class="banner-content text-center">
          ...
          >
            <img
              src="assets/img/gambar_cta_beranda.png"
              width="450px"
              alt="img"
            />
          </div>
          ...
          <div
            class="btn-box d-block fade-slide bottom"
            data-delay="0.4"
            style="
              translate: none;
              rotate: none;
        ...
        <!-- lefts-image -->
        <img
          class="animate-img-1 animate-img top_image_bounce"
          src="assets/img/banner-3/animate-1.png"
          alt="img"
          width="50px"
        />
        <img
          class="animate-img-3 animate-img spin_image shapeBlinker_img"
          src="assets/img/banner-3/animate-3.png"
          alt="img"
          width="50px"
        />
        <img
          class="animate-img-4 animate-img"
        ...
        <!-- right-image -->
        <img
          class="animate-img-6 animate-img spin_image"
          src="assets/img/banner-3/animate-3.png"
          alt="img"
          width="50px"
        />
        <img
          class="animate-img-7 animate-img spin_image"
          src="assets/img/banner-3/animate-3.png"
          alt="img"
          width="50px"
        />
        <img
          class="animate-img-8 animate-img shapeBlinker_img"
          src="assets/img/banner-3/animate-4.png"
          alt="img"
          width="50px"
        />
    ...
    <div class="about-area position-relative pd-bottom-70" style="background-color: white">
      <div class="container">
        <div class="row">
          <div
            class="col-xl-6 col-lg-10 pe-xl-5 d-flex justify-content-center align-items-center"
          >
            <div
              class="about-thumb-inner mb-4 fade-slide right"
              data-delay="0.2"
            >
              <img
                src="assets/img/logo_gurafix_no_bg.png"
                class="img-fluid"
                width="400"
                alt="img"
              />
          ...
          <div class="col-xl-6 align-self-center">
            <div class="about-content section-title mt-5 mt-xl-0 mb-0">
              ...
              <p
                class="content fade-slide bottom"
                style="margin: 0; text-align: justify; color: #004ce7"
                data-delay="0.3"
              >
              ...
              <div
                class="btn-box d-inline-block fade-slide bottom"
    ...
    <div class="gallery-area-2">
      <div class="row">
          <div class="col-lg-2 col-sm-6 px-2">
              <div class="thumb">
                  <a href="tournament-details.html"><img class="w-100" src="assets/img/portofolio/1.png" alt="img"></a>
              </div>
              <div class="thumb">
                  <a href="tournament-details.html"><img class="w-100" src="assets/img/portofolio/2.png" alt="img"></a>
              </div>
          </div>
          <div class="col-lg-2 col-sm-6 px-2">
            <div class="thumb">
              <a href="tournament-details.html"><img class="w-100" src="assets/img/portofolio/2-1.png" alt="img"></a>
            </div>
          </div>
          <div class="col-lg-2 col-sm-6 px-2">
            <div class="thumb">
                <a href="tournament-details.html"><img class="w-100" src="assets/img/portofolio/3.png"  alt="img"></a>
            </div>
            <div class="thumb">
                <a href="tournament-details.html"><img class="w-100" src="assets/img/portofolio/4.png" alt="img"></a>
            </div>
          </div>
          <div class="col-lg-2 col-sm-6 px-2">
            <div class="thumb">
              <a href="tournament-details.html"><img class="w-100" src="assets/img/portofolio/2-3.png" alt="img"></a>
            </div>
          </div>
          <div class="col-lg-2 col-sm-6 px-2">
            <div class="thumb">
                <a href="tournament-details.html"><img class="w-100" src="assets/img/portofolio/5.png"  alt="img"></a>
            </div>
            <div class="thumb">
                <a href="tournament-details.html"><img class="w-100" src="assets/img/portofolio/6.png" alt="img"></a>
            </div>
          </div>
          <div class="col-lg-2 col-sm-6 px-2">
            <div class="thumb">
              <a href="tournament-details.html"><img class="w-100" src="assets/img/portofolio/3-3.png" alt="img"></a>
            </div>
          </div>
      </div>
    </div>
    ...
    <div class="creator-area pd-top-60 pd-bottom-100 bg-cover">
      <div class="container">
        ...
        <div class="row mt-5">
          <div class="col-lg-6 mb-lg-0 mb-5 fade-slide bottom" data-delay="0.8">
            <div class="trusted-wallet-inner">
              ...
              <div class="content-inner text-center">
                ...
                <span >Layanan 1</span>
                <h3 style="color: white;">Desain Promosi dan Media <br> Cetak</h3>
              </div>
            </div>
          </div>
          <div class="col-lg-6 fade-slide bottom" data-delay="0.9">
            <div class="trusted-wallet-inner">
              <img class="bg-one w-100" src="assets/img/bg/5.png" alt="img" />
              <div class="content-inner text-center">
                <div class="icon">
                ...
                <span >Layanan 2</span>
                <h3 style="color: white;">Desain Media Sosial dan <br> Digital</h3>
              </div>
            </div>
          </div>
          <div
      ...
      <div class="container">
        ...
        <div class="swiper mySwiper2 swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden">
          <div
            ...
            id="swiper-wrapper-542360044bd9be21"
            aria-live="off"
            style="
          ...
          >
            ...
            >
              <div class="feedback-inner">
                ...
                <p>
                    Gurafix benar-benar partner kreatif yang bisa diandalkan. Mulai dari poster acara sampai banner outdoor, semuanya dikerjakan dengan detail dan profesional.
                </p>
              </div>
            </div>
            ...
            >
              <div class="feedback-inner">
                <img src="assets/img/testimonial/1.png" alt="img" />
                <p>
                    Desain packaging yang dibuat Gurafix bikin produk kami terlihat lebih premium. Sangat puas dengan hasil kerjanya! Pastinya akan repeat order.
                </p>
              </div>
            </div>
        ...
        <div class="swiper mySwiper feedback-list-slider swiper-initialized swiper-horizontal swiper-pointer-events swiper-watch-progress swiper-thumbs">
