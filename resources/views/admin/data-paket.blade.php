                                ...
                                <td>
                                    <div class="author-area">
                                        <button class="geex-btn geex-btn--primary edit-btn" data-bs-toggle="modal"
                                            ...
                                            data-fitur="{{ $paket->fitur }}" data-harga="{{ $paket->harga }}"
                                            data-durasi_pengerjaan="{{ $paket->durasi_pengerjaan }}">Edit</button>
                ...
                <div class="modal-body">
                    <form method="POST" action="{{ route('data-paket.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="geex-content__form__single__box mb-20">
                            <input type="text" placeholder="Masukkan nama paket" class="form-control" id="nama"
                                name="nama" required>
                        </div>
                        ...
                        <div class="geex-content__form__single__box mb-20">
                            <input type="text" placeholder="Masukkan fitur" class="form-control" id="fitur"
                                name="fitur" required>
                        </div>

                        <label for="harga" class="form-label">Harga</label>
                        <div class="geex-content__form__single__box mb-20">
                            <input type="number" placeholder="Masukkan harga" class="form-control" id="harga"
                                name="harga" required>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form method="POST" id="editForm" enctype="multipart/form-data">
                        ...
                        <label for="fitur" class="form-label">Fitur</label>
                        <div class="geex-content__form__single__box mb-20">
                            <input type="text" placeholder="Masukkan fitur" class="form-control" id="editFitur"
                                name="fitur" required>
                        </div>

                        <label for="harga" class="form-label">Harga</label>
                        <div class="geex-content__form__single__box mb-20">
                            <input type="number" placeholder="Masukkan harga" class="form-control" id="editHarga"
                                name="harga" required>
                        </div>
    ...
    <script>
        document.querySelectorAll('.edit-btn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                document.getElementById('currentGambarPaket').src =
                    `/assets_admin/gambar_paket/${gambar_paket}`;
