                    ...
                    <div class="geex-content__section geex-content__section--transparent geex-content__chat">
                        ...
                        <div class="geex-content__chat__sidebar">
                            ...
                            <ul class="nav nav-tabs geex-content__chat__sidebar__tab mb-20" role="tablist">
                                        ...
                                        <div class="geex-chat-tab-single">
                                            ...
                                            <div class="geex-chat-tab-single__content">
                                                <div class="geex-chat-tab-single__message">
                                                    ...
                                                    <span class="geex-chat-tab-single__subtitle">Hi David, can you send
                                                        your...</span>
                                                </div>
                                ...
                                <li class="nav-item" role="presentation">
                                    <a href="#" class="nav-link" id="geex-chat-tab-2" data-bs-toggle="tab"
                                        data-bs-target="#geex-chat-content-2" type="button" role="tab"
                                        aria-controls="geex-chat-content-2" aria-selected="true">
                                        <div class="geex-chat-tab-single">
                                            <div class="geex-chat-tab-single__img">
                                                <img src="assets/img/avatar/chat/1.svg" alt="avatar" />
                                ...
                                <li class="nav-item" role="presentation">
                                    <a href="#" class="nav-link unread" id="geex-chat-tab-3"
                                        data-bs-toggle="tab" data-bs-target="#geex-chat-content-3" type="button"
                                        role="tab" aria-controls="geex-chat-task-3" aria-selected="true">
                                        <div class="geex-chat-tab-single">
                                            <div class="geex-chat-tab-single__img">
                                                <img src="assets/img/avatar/chat/1.svg" alt="avatar" />
                                                <span class="geex-chat-tab-single__status"></span>
                                            ...
                                            <div class="geex-chat-tab-single__content">
                                                <div class="geex-chat-tab-single__message">
                                                    ...
                                                    <span class="geex-chat-tab-single__subtitle">I have done my task
                                                        last week..</span>
                                                </div>
                                                <div class="geex-chat-tab-single__info">
                            ...
                            <ul class="nav nav-tabs geex-content__chat__sidebar__tab mb-20" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <a href="#" class="nav-link unread" id="geex-chat-tab-4"
                                        data-bs-toggle="tab" data-bs-target="#geex-chat-content-4" type="button"
                                        role="tab" aria-controls="geex-chat-content-4" aria-selected="true">
                                        <div class="geex-chat-tab-single">
                                            <div class="geex-chat-tab-single__img">
                                                <img src="assets/img/avatar/chat/1.svg" alt="avatar" />
                                                <span class="geex-chat-tab-single__status"></span>
                                ...
                                <li class="nav-item" role="presentation">
                                    <a href="#" class="nav-link" id="geex-chat-tab-5" data-bs-toggle="tab"
                                        data-bs-target="#geex-chat-content-5" type="button" role="tab"
                                        aria-controls="geex-chat-content-5" aria-selected="true">
                                        <div class="geex-chat-tab-single">
                                            <div class="geex-chat-tab-single__img">
                                                <img src="assets/img/avatar/chat/1.svg" alt="avatar" />
                                                <span class="geex-chat-tab-single__status active"></span>
                                ...
                                <li class="nav-item" role="presentation">
                                    <a href="#" class="nav-link unread" id="geex-chat-tab-6"
                                        data-bs-toggle="tab" data-bs-target="#geex-chat-content-6" type="button"
                                        role="tab" aria-controls="geex-chat-content-6" aria-selected="true">
                                        <div class="geex-chat-tab-single">
                                            <div class="geex-chat-tab-single__img">
                                                <img src="assets/img/avatar/chat/1.svg" alt="avatar" />
                                                <span class="geex-chat-tab-single__status"></span>
                        ...
                        <div class="tab-content geex-content__chat__content">
                                ...
                                <div class="geex-content__chat__content">
                                    <div class="geex-content__chat__header">
                                        ...
                                        <div class="geex-content__chat__header__content">
                                            ...
                                            <ul class="geex-content__chat__header__filter">
                                                <li>
                                                    <a href="#"
                                                        class="geex-content__chat__header__filter__mute-btn">
                                                ...
                                                <li>
                                                    ...
                                                    <div
                                                        class="geex-content__chat__header__filter__content geex-content__header__searchform">
                                                        <input type="text" placeholder="Search"
                                                            class="geex-content__header__btn">
                                                        <i class="uil uil-search"></i>
                                                    </div>
                                                </li>
                                                <li>
                                                    ...
                                                    <div class="geex-content__chat__header__filter__content">
                                                        <ul class="geex-content__chat__header__filter__content__list">
                                                            <li
                                                                class="geex-content__chat__header__filter__content__list__item">
                                                                Status: <span>Active</span><span
                                                                    class="status-icon"></span></li>
                                                            <li
                                                                class="geex-content__chat__header__filter__content__list__item">
                                                                Name: <a href="#"
                                                                    class="geex-content__chat__header__filter__content__list__link">James
                                                                    Cameron</a></li>
                                                            <li
                                                                class="geex-content__chat__header__filter__content__list__item">
                                                                Email: <a href="#"
                                                                    class="geex-content__chat__header__filter__content__list__link">james@cameron.com</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </li>
                                                    ...
                                                    <div class="geex-content__chat__header__filter__content">
                                                        <ul class="geex-content__chat__header__filter__content__list">
                                                            <li
                                                                class="geex-content__chat__header__filter__content__list__item">
                                                                <a href="#"
                                                                    class="geex-content__chat__header__filter__content__list__link">Mute
                                                                    Notification</a>
                                                            </li>
                                                            <li
                                                                class="geex-content__chat__header__filter__content__list__item">
                                                                <a href="#"
                                                                    class="geex-content__chat__header__filter__content__list__link">Change
                                                                    Background</a>
                                                            </li>
                                                            <li
                                                                class="geex-content__chat__header__filter__content__list__item">
                                                            ...
                                                            <li
                                                                class="geex-content__chat__header__filter__content__list__item">
                                                                <a href="#"
                                                                    class="geex-content__chat__header__filter__content__list__link">Block
                                                                    User</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                    ...
                                    <div class="geex-content__chat__list">
                                        <div class="geex-content__chat__list__single">
                                            ...
                                            <div class="geex-content__chat__list__single__text">
                                                <span class="geex-content__chat__list__single__title">Ria
                                                    Tamaguchi</span>
                                                <span class="geex-content__chat__list__single__msg">Hi everyone! Let’s
                                                    start our discussion now about kick off meeting next week.</span>
                                        ...
                                        <div class="geex-content__chat__list__single active">
                                            ...
                                            <div class="geex-content__chat__list__single__text">
                                                <span class="geex-content__chat__list__single__title">David
                                                    Bekam</span>
                                                <span class="geex-content__chat__list__single__msg">Hi everyone! Let’s
                                                    start our discussion now about kick off meeting next week.</span>
                                                <span class="geex-content__chat__list__single__msg latest">Is everyone
                                    ...
                                    <div class="geex-content__chat__send">
                                        <div class="geex-content__chat__send__input">
                                            <input placeholder="Type your message..." name="chat" id="chat"
                                                value="">
                                        </div>
                            ...
                            <div class="tab-pane fade" id="geex-chat-content-2" role="tabpanel"
                                aria-labelledby="geex-chat-tab-2">
                                <div class="geex-content__chat__content">
                                    <div class="geex-content__chat__header">
                                        <div class="geex-content__chat__header__img">
                                            <img src="assets/img/avatar/chat/1.svg" alt="avatar" />
                            ...
                            <div class="tab-pane fade" id="geex-chat-content-3" role="tabpanel"
                                aria-labelledby="geex-chat-tab-3">
                                <div class="geex-content__chat__content">
                                    <div class="geex-content__chat__header">
                                        <div class="geex-content__chat__header__img">
                                            <img src="assets/img/avatar/chat/1.svg" alt="avatar" />
                                    ...
                                    <div class="geex-content__chat__send">
                                        <div class="geex-content__chat__send__input">
                                            <input placeholder="Type your message..." name="chat"
                                                id="chat" value="">
                                        </div>
                                        <div class="geex-content__chat__send__action">
                                            <div class="geex-content__chat__action__toggle__content">
                            ...
                            <div class="tab-pane fade" id="geex-chat-content-4" role="tabpanel"
                                aria-labelledby="geex-chat-tab-4">
                                <div class="geex-content__chat__content">
                                    <div class="geex-content__chat__header">
                                        <div class="geex-content__chat__header__img">
                                            <img src="assets/img/avatar/chat/1.svg" alt="avatar" />
                                        ...
                                        <div class="geex-content__chat__header__content">
                                            ...
                                            <ul class="geex-content__chat__header__filter">
                                                ...
                                                <li>
                                                    <a href="#"
                                                        class="geex-content__chat__header__filter__btn">
                                                        <i class="uil-search"></i>
                                                    </a>
                                                    <div
                                                        class="geex-content__chat__header__filter__content geex-content__header__searchform">
                            ...
                            <div class="tab-pane fade" id="geex-chat-content-5" role="tabpanel"
                                aria-labelledby="geex-chat-tab-5">
                                <div class="geex-content__chat__content">
                                    <div class="geex-content__chat__header">
                                        <div class="geex-content__chat__header__img">
                                            <img src="assets/img/avatar/chat/1.svg" alt="avatar" />
                            ...
                            <div class="tab-pane fade" id="geex-chat-content-6" role="tabpanel"
                                aria-labelledby="geex-chat-tab-6">
                                <div class="geex-content__chat__content">
                                    <div class="geex-content__chat__header">
                                        <div class="geex-content__chat__header__img">
                                            <img src="assets/img/avatar/chat/1.svg" alt="avatar" />
